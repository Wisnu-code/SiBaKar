<template>
    <div class="overflow-hidden mt-5">
        <div class="flex justify-center items center h-screen my-auto">
            <div class="flex flex-col justify-center md:flex-row md:mx-0 mx-5 text-justify">

                <div class="relative max-w-full md:m-20 flex justify-center items-center">
                    <div
                    ...
                    <!-- Teks Waktu Video -->
                    <div class="s-l-2 absolute md:left-0 left-20 md:ml-5 flex justify-center items-center">
                        <span class="text-xl relative md:-top-36 -top-28 font-medium text-gray-700">Lihat Video<br></span>
                    </div>
                </div>
