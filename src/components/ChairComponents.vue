<template>
    <div class="mt-20 max-w-full h-auto p-4 bg-newcolor text-center text-white shadow rounded-lg sm:p-8 md:mx-20">
        <div class="grid justify-items-stretch grid-cols-9 grid-rows-7 md:gap-5 gap-3 pb-20">
            <div class="col-span-7 col-start-2 bg-gray-900 rounded-lg h-7"></div>
            <div class="row-span-7 row-start-2 bg-pilar rounded-lg justify-self-start w-7"></div>
            <div class="row-span-7 col-start-9 row-start-2 bg-pilar rounded-lg justify-self-end w-7"></div>
            <div class="col-start-2 row-start-3 rounded-lg row-span-4">
                <div class="w-full h-full flex flex-col justify-evenly items-center gap-5 py-10">
                    <div class="bg-primary md:h-full h-8 w-full rounded-lg">1</div>
                    <div class="bg-secondary md:h-full h-8 w-full rounded-lg">2</div>
            ...
            <div class="col-start-4 col-span-2 row-start-7 rounded-lg h-auto w-full">
                <div class="flex flex-row w-full gap-3">
                    <h1 class="bg-primary max-w-full w-10 h-auto rounded-xl"></h1>
                    <h1 class="w-full h-full">ini adalah kode warna yang bangkunya masih kosong</h1>
                </div>
            </div>
            <div class="col-start-6 col-span-2 row-start-7 rounded-lg h-auto w-full">
                <div class="flex flex-row w-full gap-3">
                    <h1 class="bg-secondary max-w-full w-10 h-auto rounded-xl"></h1>
                    <h1 class="w-full h-full">ini adalah kode warna yang bangkunya masih kosong</h1>
                </div>
            </div>
        </div>
