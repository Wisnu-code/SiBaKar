<template>
    <div class="mt-20 max-w-full h-auto p-4 bg-bgChair text-center text-white shadow rounded-lg sm:p-8 md:mx-20">
        <div class="grid justify-items-stretch grid-cols-9 grid-rows-6 md:gap-5 gap-3 pb-20">
            <div class="col-span-7 col-start-2 bg-gray-900 rounded-lg h-7"></div>
            <div class="row-span-5 row-start-2 bg-pilar rounded-lg justify-self-start w-7"></div>
            <div class="row-span-5 col-start-9 row-start-2 bg-pilar rounded-lg justify-self-end w-7"></div>
