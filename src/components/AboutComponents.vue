<template>
    <div class="overflow-hidden">
        <div
            class="s-t mt-20 w-full p-4 text-center bg-secondary border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700 overflow-hidden">

            <!-- Section 1 -->
            <h5 class="s-l-2 mb-5 md:text-4xl text-2xl font-bold text-white dark:text-white max-w-full md:mx-20">Mulailah sekarang dan
            ...
            <p class="s-r-3 mb-5 md:text-2xl text-white text-lg dark:text-gray-400 max-w-full md:mx-20">Kami percaya bahwa
            ...
            <div
                ...
                <div class="w-full md:min-h-80 sm:w-autotext-white rounded-lg px-4 py-2.5 basis-1/3 grid content-end">
                    <div class="flex gap-1 in">
                        <div class="flex-1 ox bg-button h-12 in-1"></div>
                        <div class="flex-1 ox bg-button h-12 in-1"></div>
                        <div class="flex-1 ox bg-button h-12 in-1"></div>
                        <div class="flex-1 ox bg-button h-12 in-1"></div>
                        <div class="flex-1 ox bg-button h-12 in-1"></div>
                ...
                <div
                    class="s-b-4 w-full sm:w-auto text-white rounded-lg inline-flex items-center justify-center px-4 py-2.5 basis-1/2">

                    <div class="w-full h-auto md:min-h-80">
        ...
        <div class="mt-20 md:px-20 max-w-full h-auto p-4 text-center bg-white rounded-lg sm:p-8">
            ...
            <div class="flex flex-col md:flex-row items-stretch justify-center md:gap-10">
                <div class="self-start h-auto w-full">
                    <h1 class="s-b-4 mb-5 text-3xl font-bold text-gray-600 dark:text-white">Menjadi platform terdepan dalam
                ...
                <div class="in h-auto w-full">
                    <p class="in-1 mb-5 md:text-xl text-gray-600 font-semibold text-lg dark:text-gray-400">Kami berkomitmen
                        ...
                        yang lebih baik.</p>
                    <p class="in-1 mb-5 text-lg text-gray-600 font-semibold md:text-xl dark:text-gray-400">Di era di mana
                    ...
                    <p class="in-1 mb-5 text-lg text-gray-600 font-semibold md:text-xl dark:text-gray-400">Kami percaya bahwa
        ...
        <div class="mt-20 max-w-full h-auto p-4 text-center bg-white rounded-lg sm:p-8">
            <div class="in flex items-center justify-between md:gap-10 md:flex-row flex-col md:mx-20">
                <div class="in-1 mb-3 text-5xl md:text-8xl font-bold text-gray-600 dark:text-white">
                    500 +
                    <div class="in-2 md:text-3xl text-2xl font-bold text-gray-500 dark:text-white">Lorem, ipsum.</div>
                </div>
                <div class="in-1 mb-3 text-5xl md:text-8xl font-bold text-gray-600 dark:text-white">
                    500 +
                    <div class="in-2 md:text-3xl text-2xl font-bold text-gray-500 dark:text-white">Lorem, ipsum.</div>
        ...
        <div
            ...
            <div class="flex flex-col md:flex-row items-stretch justify-center md:gap-10">
                <div class="w-full h-auto flex flex-col items-start justify-center md:ml-20">
                    ...
                    <div class="s-r-3 mb-2 md:mb-5 text-5xl font-bold dark:text-white max-w-full">
                        Our Mission
                    </div>
                    <p class="s-b-4 mb-5 md:text-2xl text-sm dark:text-gray-400">Menjadi platform terdepan di dunia dalam
                        menyediakan solusi ruang kerja fleksibel yang menggabungkan efisiensi, kenyamanan, dan teknologi
                        modern. Kami bertujuan untuk menciptakan ekosistem ruang kerja yang memberdayakan perusahaan dan
                        karyawan dalam beradaptasi dengan perubahan cepat dunia kerja digital, sehingga mereka dapat
                ...
                <div class="s-r-3 w-full h-auto p-4 text-center bg-white border rounded-lg shadow sm:p-8">
                    <div class="in flex justify-center md:gap-10 flex-col h-full intern">
                        <div class="in-2 my-3 flex md:text-2xl text-sm font-bold text-gray-500 dark:text-white">
                            ...
                            kreativitas dan kolaborasi dengan mempermudah pengelolaan ruang secara efektif.
                        </div>
                        <div class="in-2 my-3 flex md:text-2xl text-sm font-bold text-gray-500 dark:text-white">
                            <div class="in-1 mr-5 bg-button w-12 h-auto"></div>Membantu perusahaan dalam mengoptimalkan
                            penggunaan aset kantor dan meningkatkan produktivitas tim dengan solusi ruang kerja yang
                            adaptif.
                        </div>
                        <div class="in-2 my-3 flex md:text-2xl text-sm font-bold text-gray-500 dark:text-white">
                            <div class="in-1 mr-5 bg-button w-12 h-auto"></div>Menyediakan sistem pemesanan kursi yang mudah
                            digunakan untuk memaksimalkan penggunaan ruang kerja di lingkungan kantor yang dinamis.
                        </div>
                    </div>
                </div>
