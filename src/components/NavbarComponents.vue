<template>
    <nav class="blockT mt-0 dark:bg-gray-900 md:mx-20 fixed z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
        <div class="max-w-screen flex flex-wrap items-center justify-between p-4">
            ...
            <!-- Logo -->
            <a href="/" class="slides flex items-center space-x-3 rtl:space-x-reverse">
            ...
            <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                <RouterLink to="/login">
                    <button type="button"
                    class="slides text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Masuk</button>
                </RouterLink>
                ...
                <ul
                    ...
                    <li>
                        <RouterLink to="/" exact active-class="active"
                            class="slides block py-2 px-3 rounded md:bg-transparent hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 text-gray-900 md:p-0 md:dark:text-blue-500 md:dark:hover:text-blue-500 md:focus:text-blue-400"
                    ...
                    <li>
                        <RouterLink to="/about" active-class="active"
                            class="slides block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700 md:focus:text-blue-400">Tentang</RouterLink>
                    </li>

                    <!-- Services -->
                    <li>
                        <RouterLink to="/service" active-class="active"
                            class="slides block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700 md:focus:text-blue-400">Layanan</RouterLink>
                    </li>
