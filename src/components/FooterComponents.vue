...
<section class="bg-white text-xl">
    <div class="zoom max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
        ...
        <div class="flex justify-center mt-8 h-10 space-x-6">
            <a href="#" class="text-gray-400 hover:text-blue-600">
                <span class="sr-only">Facebook</span>
                <svg class="w-6 h-6 hover:w-10 hover:h-10" aria-hidden="true" fill="currentColor" viewBox="0 0 24 24">
